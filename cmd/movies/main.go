...
import (
	...
	"github.com/irahardianto/monorepo-microservices/movies/router"
	"github.com/irahardianto/monorepo-microservices/movies/storage/mongodb"
...
func init() {
	...
	viper.AddConfigPath("cmd/movies")
